  ...
  <Page size='A4' style={[styles.page]} wrap={true}>
    <View style={[styles.header, styles.default]}>
      <View style={styles.logo}>
        <Image src={`${window.location.protocol}//${window.location.host}/logo_15_novembro.jpeg`} />
      </View>
    ...
    <View key={idx} wrap={false} style={[styles.tableRow, styles.default, styles.tableBody]}>
      <View style={styles.tableColProd}>
...
const [PDFRenderer, setPDFRenderer] = useState<any>(null);
  ...
  <Button onClick={handleOpenPDF}>
    <FontAwesomeIcon icon={faEye} className={'text-emsoft_light-main mr-2'} size='xl' title={'Gerar Pré-venda'} />
    Visualizar PDF
  </Button>
  );
  }
  ...
  <Button onClick={handleDownloadPDF}>
    <FontAwesomeIcon icon={faSave} className={'text-emsoft_light-main mr-2'} size='xl' title={'Gerar Pré-venda'} />
    Salvar PDF
  </Button>
  );
  }